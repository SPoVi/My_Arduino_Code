 ...
 * 
 * Ultima fecha de modificacion: 13/09/2021
 */
...
void loop() {
  ...
  if (micros() - g_tsLastReport > g_reporting_period){
    ...
    g_tsLastReport = micros();    // Si se pone detras se asegura que tras realizar las acciones habra el espacio seleccionado como mínimo.
    updateReadings();
    reportToMqtt();
