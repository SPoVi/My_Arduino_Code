...
{         
  ...
  g_cliente_ID = "IDSPV002";       // Get ID. Revisar TODO.
  ...
  #if REPORT_MQTT_SEPARATE
    sprintf(g_GSR_mqtt_topic, "arduino_2/%s/GSR/valor", g_cliente_ID);                // Data form AN33IoT
    sprintf(g_npaquete_mqtt_topic, "arduino_2/%s/GSR/numPaquete", g_cliente_ID);      // Data form AN33IoT
  #endif

  #if REPORT_MQTT_JSON
    sprintf(g_mqtt_json_topic, "arduino_2/%s/SENSOR", g_cliente_ID);                  // Data from AN33IoT
  #endif
...
String NewClientID()
{
  ...
  String clientID = "SPV002";                  // Iniciales + XXX
