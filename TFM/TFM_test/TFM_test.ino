...
void loop() {
  ...
  Serial.println("-- Tiempo desde que se finalizó el setup (inicio del loop)--");
  showTimeNeeded(g_tiempo_inicio, g_tiempo_actual);  // tStart_loop = g_tiempo_actual
  //Serial.println("-- Tiempo entre loops --");  // Tiene que ir despues de tStart_loop para hacerlo bien
  ...
  showTimeNeeded(tStart_update, tEnd_update);
