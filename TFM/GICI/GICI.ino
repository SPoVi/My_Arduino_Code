...
// Bucle hasta que nos conectamos
   while (!client.connected()) {
     ...
     if (client.connect(clientId.c_str())) {
       ...
       // ... and resubscribe
       client.subscribe("tema");//Tema al que nos vamos a subscribir para enviar la información
     } else {
...
//Pasamos los numeros a un vector de char para poder enviarlos al servidor 
//para esto se usa el comando itoa();


client.publish("nombredeltema",vectordondeestanlosdatos);// Enviamos el dato al tema en cuestión
